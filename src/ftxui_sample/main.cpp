...
// configuration step. It creates a namespace called `wesnoth_internal`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", wesnoth_internal::cmake::project_name, wesnoth_internal::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", wesnoth_internal::cmake::project_version);
      return EXIT_SUCCESS;
    }
